...
save("signalschr3.mat", "x_final")
Lab_2_and_3_check_exc('signalschr3.mat');

[u,y] = ReadData('signalschr3_noise_acq.mat',N1 , 40);
u_multi = u(:,9:end);
y_multi = y(:,9:end);

%% averaging time 
u_avrg = mean(u_multi,2);
y_avrg = mean(y_multi,2);
U_fft = fft(u_avrg);
Y_fft = fft(y_avrg);
H1 = Y_fft ./ U_fft;
